...
import (
	...
	"roov/internal/locations"
	"roov/pkg/db"
	internalMiddleware "roov/pkg/middleware"
	"roov/pkg/utils"
...
var (
	...
	DB_USER     = utils.GetEnv("DB_USER", "roov")
	DB_PASSWORD = utils.GetEnv("DB_PASSWORD", "roov")
	DB_NAME     = utils.GetEnv("DB_NAME", "roov")
	logger      *log.Logger
	connector   db.Db
)
